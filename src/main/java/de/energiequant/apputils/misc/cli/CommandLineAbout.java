package de.energiequant.apputils.misc.cli;
...
import de.energiequant.apputils.misc.Constants;
...
public class CommandLineAbout {
    ...
    public void printVersion() {
        ...
        ps.println();
        ps.println(Constants.DEPENDENCIES_CAPTION);
    ...
    public void printDependency(Project project) {
        ...
        sb.append(Constants.PROJECT_DEPENDENCY_LICENSE_INTRO);
